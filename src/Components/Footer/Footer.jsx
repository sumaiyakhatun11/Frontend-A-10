                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-4">
                            <img src={logo} alt="PawMart Logo" className="h-12 w-12 rounded-xl object-cover" />
                            <span className="text-2xl font-bold">
                                <span className="text-primary">Paw</span>Mart
                            </span>
                        </div>
                        <p className="text-neutral-400 mb-4">
                            Connecting loving homes with adorable companions. Your trusted platform for pet adoption and supplies.
                        </p>
                        {/* Social Media Links */}
                    ...
                    <div>
                        ...
                        <nav className="flex flex-col gap-2">
                            ...
                            <Link to="/addServices" className="text-neutral-400 hover:text-white transition-colors">
                                List Your Pet
                            </Link>
                        </nav>
                    </div>
                    ...
                    <div>
                        ...
                        <nav className="flex flex-col gap-2">
                            ...
                            <a href="mailto:support@pawmart.com" className="text-neutral-400 hover:text-white transition-colors">
                                Support
                            </a>
                        </nav>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-3 text-neutral-400">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <a href="mailto:info@pawmart.com" className="hover:text-white transition-colors">
                                    info@pawmart.com
                                </a>
                            </div>
                            <div className="flex items-center gap-3">
                ...
                <div className="container-custom py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-neutral-400 text-sm text-center md:text-left">
                            © {currentYear} PawMart. All rights reserved. Made with ❤️ for pets.
                        </p>
